...
<div className="modal-dialog">
  <div className="modal-content">
    <div className="modal-header">
      <p className="modal-title fs-5" id="exampleModalLabel"><h1 className="titulodemodalejercicio">HIIT</h1></p>
      <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div className="modal-body">
       <div className="tituloejercicio">
    ...
    <hr/>
    <div className="tipoejercicio">
      <div className="infoejercicio1m">Alta</div>
      <div className="infoejercicio1t">45 Mins</div>
      <div className="infoejercicio1">Intenso</div>
      <div className="infoejercicio1g">HIIT</div>
    </div>
    <div className="iconos">
   <img src={BannerModal} alt=""/>
    </div>
...
<div className="modal-dialog">
  <div className="modal-content">
    <div className="modal-header">
      <p className="modal-title fs-5" id="exampleModalLabel"><h1 className="titulodemodalejercicio"> ProCycling</h1></p>
      <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div className="modal-body">
       <div className="tituloejercicio">
    ...
    <hr/>
    <div className="tipoejercicio">
      <div className="infoejercicio1m">Medium, High</div>
      <div className="infoejercicio1t">45 Mins</div>
      <div className="infoejercicio1">Easy</div>
      <div className="infoejercicio1g">Cardio</div>
    </div>
    <div className="iconos">
   <img src={BannerModal} alt=""/>
    </div>
