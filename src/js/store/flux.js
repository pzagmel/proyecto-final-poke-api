    ...
    actions: {
      ...
      login: (MAIL, PASS, rememberMe) => {
        ...
        fetch(
            ...
            "https://3000-lukasoy-backendpokegym-ll1koxuj4po.ws-us85.gitpod.io/login", {
              method: "POST",
              headers: myHeaders,
              body: JSON.stringify({
                email: MAIL,
      ...
      tokenValidation: async (ruta) => {
        ...
        if (token !== "") {
          ...
          try {
            await fetch(
                "https://3000-lukasoy-backendpokegym-ll1koxuj4po.ws-us85.gitpod.io/token", {
                  method: "POST",
                  headers: myHeaders,
                  redirect: "follow",
                }
      ...
      getinfoRegister: async (user) => {
        fetch(
            "https://3000-lukasoy-backendpokegym-ll1koxuj4po.ws-us85.gitpod.io/register", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
              },
